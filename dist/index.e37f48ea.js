...
const showRecipe = async ()=>{
    const normalizeObjectKeys = (obj)=>Object.keys(obj).reduce((acc, item)=>{
            return {
                ...acc,
    ...
    try {
        ...
        const { imageUrl, title, cookingTime, servings, ingredients, publisher, sourceUrl } = normalizeObjectKeys(recipe);
...
},{"lodash":"9kitd","url:../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9kitd":[function(require,module,exports) {
var global = arguments[3];
(function() {
